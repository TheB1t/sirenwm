...
TEST(ConfigureNotify, UpdatesGeometryWhenNoPendingFlush) {
    ...
    h.core.dispatch(command::SyncWindowFromConfigureNotify{
...
TEST(ConfigureNotify, SkipsPositionWithPendingFlush) {
    ...
    h.core.dispatch(command::SetWindowPosition{ win, {300, 400} });
...
TEST(ConfigureNotify, SkipsSizeWithPendingGeometryFlush) {
    ...
    h.core.dispatch(command::SetWindowGeometry{ win, {100, 100}, {1024, 768} });
...
TEST(ConfigureNotify, SkipsBorderWidthWithPendingFlush) {
    ...
    h.core.dispatch(command::SetWindowBorderWidth{ win, 5 });
...
TEST(ConfigureNotify, NonexistentWindowReturnsFalse) {
    ...
    bool ok = h.core.dispatch(command::SyncWindowFromConfigureNotify{
